...
class Discriminator(object):
    def __init__(self, x_dim = 568):
        self.x_dim = x_dim
        self.name = 'ibd/clus_wgan/d_net'
...
class Generator(object):
    def __init__(self, z_dim = 38, x_dim = 568):
        self.z_dim = z_dim
        self.x_dim = x_dim
        self.name = 'ibd/clus_wgan/g_net'
...
class Encoder(object):
    def __init__(self, z_dim = 38, dim_gen = 30, x_dim = 568):
        self.z_dim = z_dim
        self.dim_gen = dim_gen
        self.x_dim = x_dim
        self.name = 'ibd/clus_wgan/enc_net'
